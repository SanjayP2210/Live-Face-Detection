...
A modern biometric-style face capture component built using:
...
This project provides a production-ready face capture experience with smooth detection, auto-capture, download options, and Base64 extraction.
...
Built with ❤️ by **Sanjay Panchal**
